...
import sys, os
from utils.attention import CDGAttention, C2CAttention,ACCAtention
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        #===============================================================      
        self.hwAttention = ACCAtention(512, 256, num_classes, [473//4,473//4], 7 )
    ...
    def forward(self, x):
        ...
        x = self.layer5(x5)         #1/16 512，金字塔池化
        #==============================================================       
        ...
        n, c, h, w = x4.size()       
        fr1 = self.sq5( x2 )
        fr1 = F.interpolate( fr1, (h,w), mode='bilinear', align_corners= True )#上采样到x4的h，w，通道数256
